...
const EXPECTED: &[(&str, &str, Option<&str>)] = &[
    ...
    ("module-v1/dc-pf-instance.pio.json", "package", None),
    ("module-v1/dc-pf-solution.pio.json", "package", None),
    ("module-v1/mc-ac-opf-instance.pio.json", "package", None),
    ("module-v1/mc-ac-opf-solution.pio.json", "package", None),
    ("module-v1/mc-ac-pf-instance.pio.json", "package", None),
    ("module-v1/mc-ac-pf-solution.pio.json", "package", None),
    (
