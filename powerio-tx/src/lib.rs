...
//! Surge JSON,
//! and DeepMind OPFData JSON. PowerWorld `.pwb`, OPFData, and PowerFactory
//! DGS files are read only. GO Challenge 3 defines a calculation and therefore parses only
