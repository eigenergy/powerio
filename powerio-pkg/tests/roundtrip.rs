...
#[test]
fn post143_load_voltage_model_survives_package_roundtrip() {
    // PR #143 added DistLoad::voltage_model (DistLoadVoltageModel). Prove the
    // richer payload field round-trips through the package JSON.
