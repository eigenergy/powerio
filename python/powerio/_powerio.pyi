...
def package_model_kind(text: str) -> Literal["balanced", "multiconductor", "unknown"]: ...
def package_parse_file(
    path: str, from_: Optional[str] = ..., scenario: int = ...
) -> str: ...
def package_parse_str(text: str, from_: Optional[str] = ...) -> str: ...
def package_as_balanced(text: str) -> PyNetwork: ...
def package_as_multiconductor(text: str) -> _DistNetwork: ...
def package_operating_points(text: str) -> str: ...
def package_materialize_operating_point(text: str, index: int) -> str: ...
