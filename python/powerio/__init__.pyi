...
def package_model_kind(package_json: str) -> Literal["balanced", "multiconductor", "unknown"]: ...
def package_parse_file(path: Any, from_: Optional[Format] = ..., scenario: int = ...) -> str: ...
def package_parse_str(text: str, from_: Optional[Format] = ...) -> str: ...
def package_as_balanced(package_json: str) -> Network: ...
def package_as_multiconductor(package_json: str) -> Any: ...
def package_operating_points(package_json: str) -> Optional[Dict[str, Any]]: ...
