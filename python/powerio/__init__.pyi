...
class DcIndexMap(TypedDict):
    bus_ids: List[int]
    branch_rows: List[int]
    branch_ids: List[str]
    skipped_branch_rows: List[int]
...
class BalancedNetwork:
    ...
    def calc_incidence_matrix(
        self, formula: str = ..., *, skip_zero_impedance: bool = ...
    ) -> Any: ...
    ...
    def calc_branch_flow_dc(
        self, voltage_angles: Any, formula: str = ..., *, skip_zero_impedance: bool = ...
    ) -> Any: ...
...
class LinDist3FlowOpfSolution(_MulticonductorCalculation, _CalculationSolution):
    @property
    def instance(self) -> LinDist3FlowOpfInstance: ...
    @property
...
class LinDist3FlowPfSolution(_MulticonductorCalculation, _CalculationSolution):
    @property
    def instance(self) -> LinDist3FlowPfInstance: ...
    @property
    def termination(self) -> str: ...
    @property
...
class PioModule(Generic[_T]):
    ...
    def to_lindist3flow_pf_instance(self) -> PioModule[LinDist3FlowPfInstance]: ...
