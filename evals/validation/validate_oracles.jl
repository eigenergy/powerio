...
#
#   julia --project=evals/validation validate_oracles.jl export  <tmp> <case.m>...
#   julia --project=evals/validation validate_oracles.jl compare <tmp> --m <m>... --raw <r>... --egret <e>...
#   julia --project=evals/validation validate_oracles.jl rich    <tmp> <rich.pm.json>...
#
